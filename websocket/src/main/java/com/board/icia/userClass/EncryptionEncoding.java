...
public class EncryptionEncoding {
	...
	public String key() {
		...
		return "ab_booktv_abcd0912345678";  //24Byte : TripleDES
		//return "ab_booktv_abcd09"      //16Byte : DES
	}
	...
	public String TripleDesEncoding(String ID) throws Exception {
		...
		byte[] inputBytes = amalgam.getBytes("UTF8");
		byte[] outputBytes = cipher.doFinal(inputBytes);

		//Base64.encodeBase64(outputBytes);

		String outputStr = new String(Base64.encodeBase64(outputBytes));
		return outputStr;
	}
